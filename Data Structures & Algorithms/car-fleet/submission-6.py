class Solution:
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        for pos, spd in cars:
           ...
           # compare second second last element to last eleemnt 
        ...
        ''' 
        - understanding ques deatilas
        - figuring our how car which are behind became fleet
        - why did we sort 
        - how stack came into action


        PATTERN REC:
        What screamed stack in ques "Compare the current element with the most recent relevant element"

        NOTES:
        draw the d-s graph for better understanding when car becomes fleet
        '''
